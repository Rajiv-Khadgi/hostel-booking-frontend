...
import { FiUser, FiMail, FiPhone, FiLock, FiCheckCircle, FiArrowRight, FiShield } from 'react-icons/fi';
...
export default function StudentRegister() {
  ...
  const { registerStudent, requestRegisterOtp } = useAuth();
  ...
  return (
        <div className="container mx-auto px-4 py-8 lg:py-12 flex justify-center items-center font-sans text-gray-900">
            <div className="w-full max-w-6xl bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-gray-100">
                ...
                <div className="lg:w-5/12 bg-emerald-700 relative overflow-hidden flex flex-col justify-center text-center lg:text-left text-white p-10 lg:p-14 order-1">
                    {/* Soft abstract background blobs */}
                    <div className="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 lg:-mr-32 lg:-mt-32 lg:w-96 lg:h-96 rounded-full bg-emerald-500 opacity-60 blur-3xl mix-blend-screen pointer-events-none"></div>
                    <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-64 h-64 lg:-ml-32 lg:-mb-32 lg:w-[30rem] lg:h-[30rem] rounded-full bg-emerald-900 opacity-50 blur-3xl mix-blend-multiply pointer-events-none"></div>
                    ...
                    <div className="relative z-10 w-full max-w-lg mx-auto lg:mx-0">
                        <Link to="/" className="inline-block mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight">
                            Home<span className="text-emerald-300">Space</span>.
                        </Link>

                        <h1 className="text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 lg:mb-6 leading-tight">
                            Find your perfect <br className="hidden lg:block"/>home away from home.
                        </h1>
                        <p className="text-base lg:text-lg text-emerald-100/90 mb-8 lg:mb-12 max-w-md mx-auto lg:mx-0 font-light">
                            Join thousands of students who have discovered verified, safe, and comfortable accommodations near campus.
                        </p>

                        <div className="space-y-6 hidden sm:block mt-auto">
                            <div className="flex items-center space-x-4 bg-emerald-800/40 p-4 rounded-2xl backdrop-blur-md border border-emerald-500/30">
                                <div className="bg-emerald-500/20 p-3 rounded-full shrink-0">
                                    <FiShield className="h-6 w-6 text-emerald-200" />
                                </div>
                                <div className="text-left">
                                    <p className="font-semibold text-white">Verified Properties</p>
                                    <p className="text-sm text-emerald-200/80">Every hostel is physically vetted for safety.</p>
                                </div>
                            </div>
                        </div>
                    </div>
          ...
          <div className="mb-10 flex items-center justify-between space-x-4">
            <div className="flex flex-col flex-1">
              <div className={`h-1.5 w-full rounded-full transition-all duration-500 ${!otpStep ? 'bg-emerald-600' : 'bg-emerald-100'}`}></div>
              <span className={`text-xs mt-2 font-medium ${!otpStep ? 'text-emerald-600' : 'text-gray-400'} uppercase tracking-wider`}>Account Details</span>
            </div>
            <div className="flex flex-col flex-1">
              <div className={`h-1.5 w-full rounded-full transition-all duration-500 ${otpStep ? 'bg-emerald-600' : 'bg-gray-100'}`}></div>
              <span className={`text-xs mt-2 font-medium ${otpStep ? 'text-emerald-600' : 'text-gray-400'} uppercase tracking-wider`}>Verification</span>
            </div>
          </div>
            ...
            {!otpStep ? (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`appearance-none block w-full pl-11 pr-4 py-3 border ${errors.first_name ? 'border-red-300 ring-1 ring-red-500' : 'border-gray-200'} rounded-xl shadow-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white focus:bg-white`}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`appearance-none block w-full pl-11 pr-4 py-3 border ${errors.last_name ? 'border-red-300 ring-1 ring-red-500' : 'border-gray-200'} rounded-xl shadow-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white focus:bg-white`}
                      />
                    </div>
                ...
                <div>
                  ...
                  <div className="relative opacity-80 focus-within:opacity-100 transition-opacity">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="appearance-none block w-full pl-11 pr-4 py-3 border border-gray-200 rounded-xl shadow-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white focus:bg-white"
                    />
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`appearance-none block w-full pl-11 pr-4 py-3 border ${errors.phone ? 'border-red-300 ring-1 ring-red-500' : 'border-gray-200'} rounded-xl shadow-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white focus:bg-white`}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`appearance-none block w-full pl-11 pr-4 py-3 border ${errors.confirm_password ? 'border-red-300 ring-1 ring-red-500' : 'border-gray-200'} rounded-xl shadow-sm focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all bg-gray-50 hover:bg-white focus:bg-white`}
                      />
                    </div>
              ...
              <div className="py-8 animate-in fade-in slide-in-from-right-8 duration-500">
                <div className="text-center mb-8">
                  <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-emerald-100 text-emerald-600 mb-6 border-4 border-emerald-50 shadow-inner">
                    <FiMail className="w-8 h-8" />
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Check your email</h3>
                  <p className="text-gray-500 px-4">
                    We've sent a 6-digit code to <span className="font-semibold text-emerald-700">{formData.email}</span>.
                  </p>
                </div>
                ...
                <div className="max-w-xs mx-auto mb-8">
                  ...
                  <input
                    ...
                    className="appearance-none block w-full px-6 py-4 border-2 border-emerald-200 focus:border-emerald-600 rounded-2xl shadow-sm placeholder-gray-300 focus:outline-none focus:ring-4 focus:ring-emerald-500/20 text-4xl text-center letter-spacing-[0.5em] font-mono font-bold text-gray-900 transition-all bg-white"
                    placeholder="------"
                  />
                </div>
              </div>
